    ...
    <section className="relative bg-white flex flex-col items-center min-h-screen w-full">
      ...
      >
        <h1 className="text-3xl md:text-5xl font-bold text-gray-900 leading-tight">
          <span className="text-blue-600">We are a community</span> where
          everybody understands
          <br className="hidden md:block" /> Autism and ADHD
        </h1>
        ...
        >
          We're the voice that campaigns for change. We're the specialists who
          provide training and world-class support.
        </motion.p>
      ...
      <div className="w-full max-w-6xl space-y-16 md:space-y-24">
        {services.map((service, index) => (
          <motion.div
            ...
            } items-center gap-8 md:gap-16 scroll-animate`}
          >
