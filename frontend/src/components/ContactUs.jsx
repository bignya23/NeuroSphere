...
const ContactUs = () => {
  return (
    <div className="w-full bg-gray-50 text-center py-16">
      ...
      <div className="flex flex-col md:flex-row items-center justify-center w-full px-8">
        ...
        <div className="md:w-1/2 md:pl-12 mt-8 md:mt-0">
          <p className="text-lg text-gray-700 leading-relaxed mb-8">
            Have questions, suggestions, or want to collaborate with us? We'd
            love to hear from you! Reach out to <strong>NeuroSphereAI</strong>{" "}
            through the form below or via our contact details.
          </p>
      ...
      <h2 className="text-4xl font-semibold text-blue-500 mt-16">
        Other Ways to Reach Us
      </h2>
      <div className="mt-8 text-gray-700">
        <p>
          📍 <strong>Address:</strong> 123 Innovation Street, Tech City, USA
        </p>
        <p>
          📞 <strong>Phone:</strong> +1 (123) 456-7890
        </p>
        <p>
          📧 <strong>Email:</strong> support@neurosphereai.com
        </p>
      </div>
