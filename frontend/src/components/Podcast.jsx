...
const Podcast = () => {
  ...
  return (
    <div className="flex h-screen bg-gray-50 text-gray-800 overflow-hidden">
      {/* Left Panel - 40% width */}
      <div className="w-2/5 border-r-2 border-blue-500 flex flex-col p-6 bg-white">
        ...
        <form onSubmit={handleSubmit} className="flex flex-col flex-grow">
          <div className="flex-grow">
            ...
            <textarea
              className="w-full h-64 p-4 bg-gray-100 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 resize-none shadow-sm"
      ...
      <div className="w-3/5 flex flex-col h-full bg-gray-50">
            ...
            {messages.map((message, index) => (
              <div
                ...
                className={`p-4 rounded-lg shadow-sm ${
                  message.type === "user"
                    ? "bg-blue-50 ml-16 border-l-4 border-blue-500"
                    : message.type === "system"
                    ? "bg-gray-100 border border-gray-200 text-center max-w-md mx-auto"
                    : message.speaker === "Alex"
                    ? "bg-indigo-50 mr-16 border-l-4 border-indigo-500"
                    : message.speaker === "Emma"
                    ? "bg-pink-50 mr-16 border-l-4 border-pink-500"
                    : "bg-gray-50 mr-16 border-l-4 border-blue-500"
                }`}
              >
                <div className="flex justify-between items-center mb-2">
                  <div className="flex items-center">
                    {message.type === "user" ? (
                      <div className="h-8 w-8 rounded-full bg-blue-200 flex items-center justify-center mr-2">
                        <svg
                ...
                {message.audioUrl && (
                  <div className="mt-3 ml-10">
                    <div className="flex items-center">
                      <button
                        className="flex items-center justify-center text-xs bg-blue-500 hover:bg-blue-600 text-white px-3 py-1 rounded"
                        onClick={() => {
        ...
        <div className="p-4 border-t border-gray-200 bg-white flex justify-center">
          ...
          <button
            className={`w-full py-3 px-4 rounded-lg font-medium flex items-center justify-center transition duration-200 shadow-sm ${
              isRecording
